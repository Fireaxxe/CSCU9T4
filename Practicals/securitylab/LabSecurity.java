...
public class LabSecurity
{
    ...
    public void tryMD5()
    {
        try 
        {
            ...
            do 
            {
                ...
                //Comment the 2 lines above and uncomment the 2 lines below to hide password input (will raise exception in IDE)  
    ...
    private String encodeMD5(final String input) throws Exception
    {
        ...
        //HexBinaryAdapter's marshal method converts byte[] to String representation of hexadeciaml characters
